export const responsibility = [
  {
    ...
    complexity:
      'Performs routine activities in a structured environment. Requires assistance in resolving unexpected problems. Participates in the generation of new ideas.',
    businessSkills:
